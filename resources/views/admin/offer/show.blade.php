...
{{--                        <a href="javascript:;" class="btn btn-sm btn-danger me-2"><i class="bi bi-file-earmark-pdf-fill"></i> PDF</a>--}}
                        <a href="javascript:;" onclick="document.getElementById('print').style.visibility = 'hidden'; window.print(); document.getElementById('print').style.visibility = 'visible'; " id="print" class="btn btn-sm btn-secondary"><i class="bi bi-printer-fill"></i> Yazdır ya da Kaydet</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col">
                            <div class="">
                                ...
                                <address class="m-t-5 m-b-5">
                                    ...
                                    {{ $offer->customer->province }} /
                                    {{ $offer->customer->country }}
                                    <br>
                                    Telefon: {{ $offer->customer->phone }}<br>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-invoice">
                            ...
                            <tr>
                                <th>Ürün Adı</th>
                                <th class="text-center" width="10%">Ürün Kategorisi</th>
                                <th class="text-center" width="10%">Ürün Kodu</th>
                                <th class="text-right" width="20%">Ürün Fiyatı</th>
                            </tr>
                            </thead>
                            <tbody>
                    ...
                    <div class="row bg-light align-items-center m-0">
                        ...
                        <div class="col bg-dark col-auto p-4">
                            <p class="mb-0 text-white">Toplam</p>
