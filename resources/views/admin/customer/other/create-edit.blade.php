...
@section('title', 'Yurtdışı Müşteri Ekle')
@section('content')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Yurtdışı Müşteri Ekle</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="row">
        <div class="col-xl-12 mx-auto">
            <div class="card">
                <div class="card-body">
                    <form action="{{ isset($customer) ? route('admin.other_customer.update', ['customer' => $customer]) : route('admin.other_customer.store') }}" enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="border p-4 rounded">
                            <div class="card-title d-flex align-items-center">
                                <h5 class="mb-0">Yurtdışı Müşteri Ekle</h5>
                            </div>
                            <hr>
                            <input type="hidden" name="personal_type" value="{{ \App\Enum\Customer\CustomerPersonalTypeEnum::OVERSEAS_CUSTOMER }}">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3 mt-3">
                                <label for="inputEnterYourName" class="col-sm-2 col-form-label">Eori number </label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control @error('eori_number') is-invalid @enderror" name="eori_number"
                                           value="{{ isset($customer) ? $customer->eori_number :old('eori_number') }}"
                                           id="inputEnterYourName" placeholder="Eori number">
                                    @error('tax_authority')
                                    <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>
                                <label for="inputEnterYourName" class="col-sm-2 col-form-label">Personal Number / Wat Number  </label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control @error('identity_number') is-invalid @enderror"
                                           name="identity_number" value="{{ isset($customer) ? $customer->identity_number :old('identity_number') }}"
                                            id="inputEnterYourName" placeholder="Personal number / wat number  ">
