...
@section('title', 'Ürün Etiketi Ekle')
@section('css')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ürün Etiketi Ekle</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <form action="{{ route('admin.product.tag.store') }}" method="post">
                        ...
                        <div class="border p-4 rounded">
                            <div class="card-title d-flex align-items-center">
                                <h5 class="mb-0">Ürün Etiketi Ekle</h5>
                            </div>
                            <hr>
                            ...
                            <div class="row  mt-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Ürün Etiketi">
                                    @error('name')
